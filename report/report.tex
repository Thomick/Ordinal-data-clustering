...
\ipolSetAffiliations{%
\ipolAuthorMark{1} \ipolAuthorMark{2} \ipolAuthorMark{3}  ENS Paris-Saclay, France \\
\ipolAuthorMark{1} (\texttt{thomas.michel1@ens-paris-saclay.fr})\\
\ipolAuthorMark{2}\ipolAuthorMark{3} (\texttt{firstname.lastname@ens-paris-saclay.fr})
}
