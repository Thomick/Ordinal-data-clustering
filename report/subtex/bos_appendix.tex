...
Unfornately, we were not able to prove this theorem yet. However we were able to test it numerically for every polynomial up to $m = 100$ we did not find any counter example. To do this we formally computed the second derivative of the log-derivative and checked that it was always negative on $10\ 000$ points of the interval $[0, 1]$.
